...
private function cottonPregPCChance():void {
	...
	if(flags[kFLAGS.COTTON_KID_COUNT] == 0 && flags[kFLAGS.COTTON_HERBS_OFF] == 0) {
		player.knockUp(PregnancyType.COTTON,350,600);
	}
	else {
		if(flags[kFLAGS.COTTON_HERBS_OFF] == 0) player.knockUp(PregnancyType.COTTON,350,1000);
		else player.knockUp(PregnancyType.COTTON,350,100);
	}
}
...
public function cottonGreeting():void {
	...
	//Met before
		...
		else if((player.pregnancyIncubation <= 225 && player.pregnancyIncubation > 0) && player.pregnancyType == PregnancyType.COTTON)
		{
			//Lamaze Class*
...
private function acceptYoga():void {
	...
	//(Yes) LAMAZE
	if((player.pregnancyIncubation <= 225 && player.pregnancyIncubation > 0) && player.pregnancyType == PregnancyType.COTTON) 
	{
