	...
	public class AmilyScene extends NPCAwareContent	{
		...
		*/
		...
		private function takeChargeAmilyMountHer():void {
			...
			if(flags[kFLAGS.AMILY_ALLOWS_FERTILITY] == 1) {
				player.knockUp(PregnancyType.AMILY,350);
			}
			doNext(13);
			dynStats("sen", -1, "lus=", 0);
		}
		...
		*/
		...
		public function hermilyOnFemalePC():void {
			...
			//(If player is preg
			if(player.pregnancyType == PregnancyType.AMILY && player.pregnancyIncubation > 0) outputText("\"<i>Boy, this is weird. I'm a woman and I'm going to be a dad.", false);
			//not preg yet!
			else {
