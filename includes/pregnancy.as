...
=======
	if((player.pregnancyIncubation <= 0 && player.buttPregnancyIncubation <= 0) ||
		(player.pregnancyType == PregnancyType.NONE && player.buttPregnancyType == 0)) {
>>>>>>> origin/master
		return false;
	}
	//Cancel Heat
	...
	if (player.pregnancyIncubation == 1) {
		...
		if (player.hasStatusAffect("Birthed") < 0) {
			player.createStatusAffect("Birthed",1,0,0,0);
		} else {
	...
	if (player.pregnancyIncubation > 0 && player.pregnancyIncubation < 2) {
		player.pregnancyIncubation = 1;
	}
	//IF INCUBATION IS VAGINAL
<<<<<<< HEAD
	if (player.pregnancyIncubation > 1) {
		if (player.pregnancyType == PregnancyTypeEnum.SAND_WITCH) {
			displayedUpdate = sandPregUpdate();
		}
		if (player.pregnancyType == PregnancyTypeEnum.URTA) {
			displayedUpdate = urtaPregs.urtaPregooUpdates();
		}
		//Cotton Pregnancy! - 350 days long
		if (player.pregnancyType == PregnancyTypeEnum.COTTON) {
...
>>>>>>> origin/master
		...
		//Imp Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.IMP) {
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 216) {
				...
				if (player.cor < 40) {
					outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>", false);
				} else if (player.cor < 75) {
					outputText("Considering the size of the creatures you've fucked, you hope it doesn't hurt when it comes out.</b>", false);
				} else {
					outputText("You think dreamily about the monstrous cocks that have recently been fucking you, and hope that your offspring inherit such a pleasure tool.</b>", false);
				}
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 40) {
					outputText("making it difficult to function.</b>", false);
				} else if (player.cor < 75) {
					outputText("and you wonder how much longer you have to wait.</b>", false);
				} else {
					outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>", false);
				}
				outputText("\n", false);
			...
			if (player.pregnancyIncubation == 48) {
				...
				if (player.cor < 40) {
					outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n", false);
				} else if (player.cor < 75) {
					outputText("You estimate you'll give birth in the next few days.</b>\n", false);
				} else {
					outputText("You find yourself daydreaming about birthing demons repeatedly, each time being re-impregnated by your hordes of lusty adolescent children.</b>\n", false);
				}
				displayedUpdate = true;
			}
		}
		//Minotaur Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.MINOTAUR) {
			if (player.pregnancyIncubation == 336) {
=======
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 40) {
					...
					outputText("and you're eager to give birth, so you can get impregnated again by monstrous cocks unloading their corrupted seed directly into your eager womb.</b>", false);
				}
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
				...
				if (player.cor < 40) {
					...
					outputText("You find yourself daydreaming about birthing some huge monstrous beast, and raising it to fuck your wet pussy over and over.</b>\n", false);
				}
		...
		//Centaur Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.CENTAUR) {
			if (player.pregnancyIncubation == 350) {
=======
		if(player.pregnancyType == PregnancyType.CENTAUR) {		
			if(player.pregnancyIncubation == 350) {
>>>>>>> origin/master
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 156) {
				...
				if (player.cor < 40) {
					...
					outputText("You find yourself wondering what giving birth to bunny-girls is like.</b>", false);
				} else {
					outputText("You dreamily wonder if you could find a bunny willing to put more than two eggs inside you at once.</b>", false);
				}
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				outputText("\n", false);
				displayedUpdate = true;				
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 40) {
					...
					outputText("and you're eager to give birth so you'll be able to get pregnant again.</b>", false);
				}
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			...
			if (player.pregnancyIncubation == 48) {
				...
				if (player.cor < 40) {
					...
					outputText("You find yourself daydreaming about birthing bunnies repeatedly, each time being re-impregnated with dozens of eggs from your lusty adolescent children.</b>\n", false);
				}
				displayedUpdate = true;
			}
		}
		//Marblz Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.MARBLE) {
			if (player.pregnancyIncubation == 336) {
=======
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 40) {
					...
					outputText("and you're eager to give birth, so you can get fill your womb with a new charge.</b>", false);
				}
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
		...
		//Jojo Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.MOUSE) {
			if (player.pregnancyIncubation == 336) {
=======
		if(player.pregnancyType == PregnancyType.MOUSE) {			
			if(player.pregnancyIncubation == 336) {
>>>>>>> origin/master
				outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n", false);
				displayedUpdate = true;
			...
			if (player.pregnancyIncubation == 48) {
				...
				if (player.cor < 40) {
					...
					outputText("You find yourself daydreaming about birthing hundreds of little babies, and lounging around while they nurse non-stop on your increasingly sensitive breasts.</b>\n", false);				
				}
			}
			if (player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
				//Increase lactation!
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 216) {
				...
				if (flags[kFLAGS.AMILY_FOLLOWER] == 1) {
					outputText("  Amily smiles at you reassuringly. \"<i>We do have litters, dear, this is normal.</i>\"", false);
				}
				outputText("</b>", false);
				outputText("\n", false);
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
		...
		//Shark Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.IZMA) {
...
>>>>>>> origin/master
		...
		//SPOIDAH Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.SPIDER || player.pregnancyType == PregnancyTypeEnum.DRIDER) {
			if (player.pregnancyIncubation == 399) {
=======
		if(player.pregnancyType == PregnancyType.SPIDER || player.pregnancyType == PregnancyType.DRIDER) {	
			if(player.pregnancyIncubation == 399) {
>>>>>>> origin/master
...
<<<<<<< HEAD
				if (player.pregnancyType == PregnancyTypeEnum.SPIDER) {
					outputText("spider-morphs ", false);
				} else {
					outputText("driders ", false);
				}
=======
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 50) {
					outputText("  You shudder and shake your head, wondering why you're thinking such unusual things.", false);
				}
				outputText("</b>\n", false);
				displayedUpdate = true;
			}
		...
		//Goo Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.GOO) {
			if (player.pregnancyIncubation == 72) {
=======
		if(player.pregnancyType == PregnancyType.GOO) {	
			if(player.pregnancyIncubation == 72) {
>>>>>>> origin/master
...
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.EMBER) {
=======
...
>>>>>>> origin/master
		...
		//Pregnancy 4 Satyrs
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.SATYR) {
=======
...
>>>>>>> origin/master
		...
		//Anemone Pregnancy
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.ANEMONE) {
...
>>>>>>> origin/master
			...
			if (player.pregnancyIncubation == 185) {
				...
				if (player.cor < 40) {
					...
					outputText("Considering the possible fathers, you hope it isn't that big.</b>", false);
				} else {
					outputText("You think dreamily about the cocks that have recently been fucking you, and hope that your offspring inherit such a divine pleasure tool.</b>", false);
				}
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				outputText("\n", false);
				displayedUpdate = true;				
			...
			if (player.pregnancyIncubation == 120) {
				...
				if (player.hasVagina()) {
					outputText(" and keeps your " + vaginaDescript(0) + " aroused from the constant tingling in your womb", false);
				}
				outputText(".</b>\n", false);
			...
			if (player.pregnancyIncubation == 72) {
				...
				if (player.cor < 40) {
					outputText("and constantly shifts and wriggles.  What manner of beast are you bringing into the world?</b>", false);
				} else if (player.cor < 75) {
					outputText("and you wonder how much longer you have to wait.</b>", false);
				} else {
					outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>", false);
			...
			if (player.pregnancyIncubation == 48) {
				outputText("\n<b>You rub your hands over your bulging belly, lost in the sensations of motherhood.  ", false);
				if (player.cor < 40) {
					outputText("Afterwards you feel somewhat disgusted with yourself, but horny.</b>\n", false);
				} else if (player.cor < 75) {
					outputText("You estimate you'll give birth in the next few days.  You hope the birth is as erotically charged as the pregnancy has been.</b>\n", false);
				} else {
					outputText("You find yourself daydreaming about about birthing cilia-covered worms, orgasming each time their thousands of stingers brush by your clit and fill it full of sensation-enhancing drugs.</b>\n", false);
				}
		...
		//Hellhound Pregnancy!
<<<<<<< HEAD
		if (player.pregnancyType == PregnancyTypeEnum.HELLHOUND) {
			if (player.pregnancyIncubation == 290) {
=======
		if(player.pregnancyType == PregnancyType.HELLHOUND) {			
			if(player.pregnancyIncubation == 290) {
>>>>>>> origin/master
				outputText("\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n", false);
				displayedUpdate = true;
		...
		//Frog Eggs
<<<<<<< HEAD
		else if (player.pregnancyType == PregnancyTypeEnum.FROG) {
			if (player.pregnancyIncubation == 8) {
=======
		else if(player.pregnancyType == PregnancyType.FROG) {
			if(player.pregnancyIncubation == 8) {
>>>>>>> origin/master
				//Egg Maturing
				if (player.hasVagina()) {
...
<<<<<<< HEAD
	if (player.buttPregnancyIncubation > 1) {
		if (player.buttPregnancyType == PregnancyTypeEnum.FROG) {
			if (player.buttPregnancyIncubation == 8) {
=======
	if(player.buttPregnancyIncubation > 1) {
		if(player.buttPregnancyType == PregnancyType.FROG) {
			if(player.buttPregnancyIncubation == 8) {
>>>>>>> origin/master
				//Egg Maturing
				...
				//[cock:
					...
					outputText("  Splashing against the underside of your " + multiCockDescriptLight() + ", the slime leaves a warm, oozy sensation that makes you just want to rub [eachCock] over and over and over again.");
				}
				//genderless: 
				else {
					outputText("  Your asshole begins twitching, aching for something to push through it over and over again.");
				}
				outputText("  Seated in your own slime, you moan softly, unable to keep your hands off yourself.");
				dynStats("lus=", 100, "resisted", false);
				displayedUpdate = true;
		...
		//Pregnancy 4 Satyrs
<<<<<<< HEAD
		if (player.buttPregnancyType == PregnancyTypeEnum.SATYR) {
=======
			...
			if (player.buttPregnancyIncubation == 20) {
				...
				if (player.cockTotal() == 1) {
					...
					if (player.horseCocks() == 1) {
						outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your " + cockDescript(0) + " is twitching and dripping, the flare swollen and purple.  ", false);
					}
					if (player.dogCocks() == 1) {
						outputText(", each inhalation making it thicker, harder, and firmer.  You suck in huge lungfuls of air, desperate for more, until your " + cockDescript(0) + " is twitching and dripping, its knot swollen to the max.  ", false);
					}
					if (player.normalCocks() == 1) {
						outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your " + cockDescript(0) + " is twitching and dripping, the head swollen and purple.  ", false);
					}
					//FAILSAFE FOR NEW COCKS
					if (player.normalCocks() == 0 && player.dogCocks() == 0 && player.horseCocks() == 0) {
						outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air until your " + cockDescript(0) + " is twitching and dripping.  ", false);
					}
				}
				if (player.cockTotal() > 1) {
					outputText("groin.  Your " + multiCockDescriptLight() + " fill and grow with every lungful of the stuff you breathe in.  You suck in great lungfuls of the tainted air, desperate for more, your cocks twitching and dripping with need.  ", false);
				}
...
<<<<<<< HEAD
	if (player.buttPregnancyIncubation == 1 && player.buttPregnancyType == PregnancyTypeEnum.FROG) {
=======
	if(player.buttPregnancyIncubation == 1 && player.buttPregnancyType == PregnancyType.FROG) {
>>>>>>> origin/master
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.EMBER) {
=======
...
>>>>>>> origin/master
	...
	if (player.buttPregnancyIncubation == 1 && player.buttPregnancyType == 2) {
		...
		if (player.cockTotal() > 0) {
			outputText("The muzzy feeling that fills your head seems to seep downwards, making your equipment hard and tight.  ", false);
		}
		if (player.vaginas.length > 0) {
			outputText("Your " + vaginaDescript(0) + " becomes engorged and sensitive.  ", false);
		}
		...
		if (player.averageLactation() >= 1 && player.biggestTitSize() > 2) {
			outputText("Seeking even greater sensation, your hands gather the honey and massage it into your " + breastDescript(0) + ", slowly working up to your nipples.  Milk immediately begins pouring out from the attention, flooding your chest with warmth.  ", false);
		}
		...
		if (player.cor < 35) {
			outputText("You are disgusted, but glad you were not stung during the ordeal.  You stagger away and find a brook to wash out your mouth with.", false);
		} else if (player.cor < 65) {
			outputText("You are amazed you could lay so many eggs, and while the act was strange there was something definitely arousing about it.", false);
		} else if (player.cor < 90) {
			outputText("You stretch languidly, noting that most of the drugged honey is gone.  Maybe you can find the Bee again and remember to bottle it next time.", false);
		} else {
			outputText("You lick your lips, savoring the honeyed residue on them as you admire your thousands of children.  If only every night could be like this...\n", false);
		}
		player.buttPregnancyIncubation = 0;
		player.buttPregnancyType=0;
...
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.URTA && player.pregnancyIncubation == 1) {
=======
...
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.SAND_WITCH && player.pregnancyIncubation == 1) {
=======
...
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.IZMA && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
	...
	//SPOIDAH BIRF
<<<<<<< HEAD
	if ((player.pregnancyType == PregnancyTypeEnum.SPIDER) && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
	...
	//DRIDER BIRF
<<<<<<< HEAD
	if ((player.pregnancyType == PregnancyTypeEnum.DRIDER) && player.pregnancyIncubation == 1) {
=======
	if((player.pregnancyType == PregnancyType.DRIDER) && player.pregnancyIncubation == 1) {
>>>>>>> origin/master
		player.pregnancyIncubation = 0;
		player.pregnancyType = PregnancyType.NONE;
		displayedUpdate = true;
...
<<<<<<< HEAD
	if ((player.pregnancyType == PregnancyTypeEnum.COTTON) && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
	...
	//GOO BIRF
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.GOO && player.pregnancyIncubation == 1) {
=======
	if(player.pregnancyType == PregnancyType.GOO && player.pregnancyIncubation == 1) {
>>>>>>> origin/master
		player.pregnancyIncubation = 0;
		player.pregnancyType = PregnancyType.NONE;
		displayedUpdate = true;
...
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.BASILISK && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
	...
	//Satyr vag preg
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.SATYR && player.pregnancyIncubation == 1) {
=======
...
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.BENOIT && player.pregnancyIncubation <= 2) {
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.FROG) {
=======
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.FROG) {
>>>>>>> origin/master
	...
	//Bunbun birfs
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.BUNNY && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
		...
		if (player.vaginalCapacity() < 60) {
			outputText("It hurts a little as your cervix starts to stretch wide", false);
		} else {
			outputText("It actually feels kind of nice as your cervix is stretched wide", false);
		}
		...
		if (player.lactationQ() > 500) {
			outputText(", growing fat from all the milk", false);
		}
	...
	//Anemone Pregnancy
<<<<<<< HEAD
	if (player.pregnancyType == PregnancyTypeEnum.ANEMONE && player.pregnancyIncubation == 1) {
=======
...
>>>>>>> origin/master
		...
		//[(if pc has 0-9 existing cocks)
			...
			//[(if cocks)
			if (player.cockTotal() > 0) {
				outputText(" below your " + multiCockDescriptLight(), false);
			}
			...
			//[(dick slot 1 exists)
			if (player.cockTotal() > 0) {
				outputText("  The tentacles writhe around, rubbing against your " + multiCockDescriptLight(), false);
			}
			//(doesn't exist)
			else {
				outputText("  The tentacles curl inwards, rubbing on the head of your new blue pecker", false);
			}
			...
			if (player.totalCocks() == 1 && player.balls == 0) {
				outputText("; you feel a pressure build below the shaft, near your asshole", false);
			}
			outputText(".  As the venom and the rubbing work you to the edge of climax, your muscles clench and a ", false);
			if (player.cumQ() < 100) {
				outputText("glob", false);
			} else if (player.cumQ() < 500) {
				outputText("squirt", false);
			} else {
				outputText("spray", false);
			}
			outputText(" of semen shoots from your new penis and lands on your ", false);
			//[(if boobs)
			if (player.biggestTitSize() >= 1) {
				outputText(allBreastsDescript() + " and ", false);
			}
			outputText("stomach", false);
			//[(dick1 exists)
			if (player.cockTotal() > 1) {
				outputText(", followed in short order by white squirts from " + sMultiCockDesc() + " remaining", false);
			}
			...
			if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) {
				outputText("a trickle", false);
			} else if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) {
				outputText("a squirt", false);
			} else {
				outputText("nearly a cupful of fluid", false);
			}
		...
		//[(if PC has 10 existing cocks) && no kid
			...
			if (player.hasStatusAffect("Anemone Arousal") < 0) {
				player.createStatusAffect("Anemone Arousal",0,0,0,0);
			}
		}		
		player.pregnancyIncubation = 0;
		player.pregnancyType = PregnancyType.NONE;
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.IMP) {
=======
...
>>>>>>> origin/master
		...
		if (player.hasStatusAffect("Birthed Imps") >= 0) {
			player.addStatusValue("Birthed Imps",1,1);
		} else {
			player.createStatusAffect("Birthed Imps",1,0,0,0);
		}
		if (player.vaginas.length == 0) {
			outputText("You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ", false);
			player.createVagina();
		...
		if (player.cor < 50) {
			outputText("You rue the day you encountered that hateful imp.  ", false);
		}
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.MARBLE) {
=======
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.MINOTAUR) {
		if (player.vaginas.length == 0) {
=======
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.AMILY) {
		if (flags[kFLAGS.AMILY_FOLLOWER] == 2 || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00170] > 0) {
...
=======
	...
	{
		if(flags[kFLAGS.AMILY_FOLLOWER] == 2 || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00170] > 0) player.pregnancyType = PregnancyType.MOUSE;
	}
	//Amily failsafe - converts PC with pure babies to mouse babies if Amily is with Urta
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.AMILY) 
	{
		if(flags[kFLAGS.AMILY_VISITING_URTA] == 1 || flags[kFLAGS.AMILY_VISITING_URTA] == 2) player.pregnancyType = PregnancyType.MOUSE;
	}
	//Give birth if it's time (to an AMILY BITCH mouse!)
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.AMILY) {
>>>>>>> origin/master
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.MOUSE) {
=======
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.MOUSE) {
>>>>>>> origin/master
		player.boostLactation(.01);
...
>>>>>>> origin/master
		...
		if (player.buttRating < 14 && rand(2) == 0) {
			if (player.buttRating < 10) {
				player.buttRating++;
				outputText("\n\nYou notice your " + buttDescript() + " feeling larger and plumper after the ordeal.", false);				
			} else if (player.buttRating < 14 && rand(2) == 0) { //Big butts grow slower!
				player.buttRating++;
				outputText("\n\nYou notice your " + buttDescript() + " feeling larger and plumper after the ordeal.", false);
			}
		}
	...
	//Centaur Baby!
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.CENTAUR) {
=======
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.CENTAUR) {
>>>>>>> origin/master
...
<<<<<<< HEAD
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyTypeEnum.HELLHOUND) {
=======
	if(player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.HELLHOUND) {
>>>>>>> origin/master
		...
		if (player.pregnancyIncubation == 1) {
			...
			if (player.statusAffects[player.hasStatusAffect("eggs")].value2 == 0) {
				...
				//High quantity
					...
					if (player.clitLength > 5) {
						outputText("jerking on your huge clitty as if it were a cock, moaning and panting as each egg slides free of your diminishing belly.  You lubricate it with a mix of your juices and the slime until ", false);
					}
					if (player.clitLength > 2 && player.clitLength <= 5) {
						outputText("playing with your over-large clit as if it were a small cock, moaning and panting as the eggs slide free of your diminishing belly.  You spread the slime and cunt juice over it as you tease and stroke until ", false);
					}
					if (player.clitLength <= 2) {
						outputText("pulling your folds wide and playing with your clit as another egg pops free from your diminishing belly.  You make wet 'schlick'ing sounds as your spread the slime around, vigorously frigging yourself until ", false); 
					}
			...
			//Large egg scene
				...
				if (player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS_LOOSE) {
					outputText("stretching your tight cunt painfully, the lips opening wide ", false);
				}
				if (player.vaginas[0].vaginalLooseness >= VAGINA_LOOSENESS_LOOSE && player.vaginas[0].vaginalLooseness <= VAGINA_LOOSENESS_GAPING_WIDE) {
					 outputText("temporarily stretching your cunt-lips wide-open ", false);
				 }
				if (player.vaginas[0].vaginalLooseness > VAGINA_LOOSENESS_GAPING_WIDE) {
					outputText("parting your already gaping lips wide ", false);
				}
				...
				if (player.clitLength > 5) {
					outputText("your massive cock-like clit, jacking it off with the slimy birthing fluids as lube.   It pulses and twitches in time with your heartbeats, it's sensitive surface overloading your fragile mind with pleasure.  ", false);
				}
				if (player.clitLength > 2 && player.clitLength <= 5) {
					outputText("your large clit like a tiny cock, stroking it up and down between your slime-lubed thumb and fore-finger.  It twitches and pulses with your heartbeats, the incredible sensitivity of it overloading your fragile mind with waves of pleasure.  ", false);
				}
				if (player.clitLength <= 2) {
					outputText("your " + vaginaDescript(0) + " by pulling your folds wide and playing with your clit.  Another egg pops free from your diminishing belly, accompanied by an audible burst of relief.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself.  ", false);
				}
				...
				if (player.statusAffects[player.hasStatusAffect("eggs")].value3 >= 11) {
			...
			if (player.hasStatusAffect("ateEgg") >= 0) {
				outputText("but you remember the effects of the last one you ate.\n</b>", false);
			} else {
...
public function eggDescript(plural:Boolean = true):String {
	...
	if (player.hasStatusAffect("eggs") >= 0) {
		...
		5 - rubbery black - 
		*/
		var colors:Array = ["brown", "purple", "blue", "pink", "white", "rubbery black"];
		descript += colors[player.statusAffects[player.hasStatusAffect("eggs")].value1] || "mystery colored";
