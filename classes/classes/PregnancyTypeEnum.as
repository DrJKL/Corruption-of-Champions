package classes {
	public class PregnancyTypeEnum {
		...
		public static const TENTACLE:int = 3;  // "Tentacle"
		public static const MOUSE:int = 4;  // "Mouse-morph (Jojo/Corrupt Amily)"
		public static const EGGZ:int = 5;  // "EGGZ"
		public static const HELLHOUND:int = 6;  // "Hellhound"
		public static const CENTAUR:int = 7;  // "Centaur (Kelt)"
		public static const MARBLE:int = 8;  // "Cowgirls (Marble)"
		public static const BUNNY:int = 9;  // "Bunny"
		public static const ANEMONE:int = 10; // "Anemone"
		public static const AMILY:int = 11; // "Mouse-morph (Amily)"
		public static const IZMA:int = 12; // "Shark-morph (Izma)"
		public static const SPIDER:int = 13; // "Spider-morph"
		public static const BASILISK:int = 14; // "Basilisk"		
		public static const DRIDER:int = 15; // "Drider"
		public static const GOO:int = 16; // "Goo-girl"
		public static const EMBER:int = 17; // "Dragon (Ember)"
		public static const BENOIT:int = 18; // "Basilisk (Benoit)" // BENOIT ONLY
		public static const SATYR:int = 19; // "Satyr"
		public static const COTTON:int = 20; // "Equine-morph (Cotton)"
		public static const URTA:int = 21; // "Fox-morph (Urta)"
		public static const SAND_WITCH:int = 22; // "Sand Witch"
		public static const FROG:int = 23; // "Frog Girl"
	}
}
/*
